...
//			System.out.println("현재페이지 =" + p_currentPage);
			...
			dispatcher = request.getRequestDispatcher("product/products.jsp");
...
// 			List<ProductDTO> laptopList = getProductList(); 메서드 호출
			...
			if (orderBy != null) {
				...
				} else if ("laptopPopular".equals(orderBy)) {
			...
			dispatcher = request.getRequestDispatcher("product/laptop.jsp");
			dispatcher.forward(request, response);
		} // laptop.po
...
// 			List<ProductDTO> laptopList = getProductList(); 메서드 호출
			...
			if (orderBy != null) {
				...
				} else if ("phonePopular".equals(orderBy)) {
			...
			// 주소변경없이 이동 center/laptop.jsp
			dispatcher = request.getRequestDispatcher("product/phone.jsp");
			dispatcher.forward(request, response);
		} // phone.po
...
//		 			List<ProductDTO> laptopList = getProductList(); 메서드 호출
			...
			if (orderBy != null) {
				...
				} else if ("tabletPopular".equals(orderBy)) {
			...
			// 주소변경없이 이동 center/laptop.jsp
			dispatcher = request.getRequestDispatcher("product/tablet.jsp");
			dispatcher.forward(request, response);
		} // tablet.po
		...
		if (sPath.equals("/productReg.po")) {
			...
			dispatcher = request.getRequestDispatcher("product/productReg.jsp");
			dispatcher.forward(request, response);
		...
		if (sPath.equals("/productUpdate.po")) {
			...
			dispatcher = request.getRequestDispatcher("product/productUpdate.jsp");
			dispatcher.forward(request, response);
		...
		if (sPath.equals("/single.po")) {
			...
			dispatcher = request.getRequestDispatcher("product/single.jsp");
			dispatcher.forward(request, response);
		...
		if (sPath.equals("/buylist.po")) {
			...
			dispatcher = request.getRequestDispatcher("product/buylist.jsp");
			dispatcher.forward(request, response);
...
//			request.setAttribute("productList2", productList2);
		...
		if (sPath.equals("/buylist2.po")) {
			...
			dispatcher = request.getRequestDispatcher("product/buylist2.jsp");
			dispatcher.forward(request, response);
...
//		    }	
			...
			dispatcher = request.getRequestDispatcher("product/wishlist.jsp");
			dispatcher.forward(request, response);
		} // wishlist.po
