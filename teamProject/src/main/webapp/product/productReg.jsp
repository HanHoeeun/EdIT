	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<!-- 상품 제목, 가격, 상품설명 -->
				<form action="productRegPro.po" method="post"
					enctype="multipart/form-data">
					<input type="text" name="m_id" value="<%=memberDTO.getM_id()%>"
						readonly="readonly"> <input type="text" name="m_nick"
						value="<%=memberDTO.getM_nick()%>" readonly="readonly"> <input
						type="text" name="p_title" placeholder="제목을 입력하세요..." required>
					...
					<div class="register-check-box">
						<div style="display: flex;">
							...
							</select> <select name="p_status" id="p_status" required
