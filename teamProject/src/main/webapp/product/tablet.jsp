...
<nav class="numbering">
   <ul class="pagination paging">
      ...
      if(ppageDTO.getP_startPage() > ppageDTO.getP_pageBlock()){
         %>
         <a href="tablet.po?p_pageNum=<%=ppageDTO.getP_startPage()-ppageDTO.getP_pageBlock()%>&orderBy=${orderBy}" aria-label="Previous">
      ...
      for(int i=ppageDTO.getP_startPage();i<=ppageDTO.getP_endPage();i++){
         %>
         <a href="tablet.po?p_pageNum=<%=i%>&orderBy=${orderBy}"><%=i %><span class="sr-only">(current)</span></a>
         <%
         }
         %>
      </li>
      ...
      if(ppageDTO.getP_endPage() < ppageDTO.getP_pageCount()){
         %>
         <a href="tablet.po?p_pageNum=<%=ppageDTO.getP_startPage()+ppageDTO.getP_pageBlock()%>&orderBy=${orderBy}" aria-label="Next">
