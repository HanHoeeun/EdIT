...
<!-- 					<img id="example" src="../images/si1.jpg" alt=" " class="img-responsive"> -->
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<!-- 채팅, 신고하기, 상품목록 버튼 -->
					<a href="#" onclick="window.open('chat.ch?ch_toID=<%= productDTO.getM_id()%>','1:1 채팅','width=800, height=500, scrollbars=yes')" ><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>1:1 채팅</a>
