			...
			<div class="container_2_1">
				...
				<ul class="tabs">
					...
					<li class="tab-link current"
						onclick="location.href='adminBlackPage.ad'">블랙리스트</li>
			...
			<div class="container_3_1">
				...
				<div id="tab-3" class="tab-content current">
					<table class="_1qna_board">
						...
						%>
						<tr
							onclick="window.open('userContent.ad?m_num=<%=memberDTO.getM_num()%>','회원정보 상세','width=800, height=700, scrollbars=yes')">
					...
					<div class="_1qna_paging">
						<ul>
							...
							%>
							<li
								onclick="location.href='adminBlackPage.ad?pageNum=<%=pageDTO.getStartPage() - pageDTO.getPageBlock()%>&search=<%=pageDTO.getSearch()%>'">Prev</li>
							...
							%>
							<li
								onclick="location.href='adminBlackPage.ad?pageNum=<%=i%>&search=<%=pageDTO.getSearch()%>'"><%=i%></li>
							<%
							}
							if (pageDTO.getEndPage() < pageDTO.getPageCount()) {
							%>
							<li
								onclick="location.href='adminBlackPage.ad?pageNum=<%=pageDTO.getStartPage() + pageDTO.getPageBlock()%>&search=<%=pageDTO.getSearch()%>'">Next</li>
							<%
							}
							%>
						</ul>
					...
					<!-- 					검색테이블  -->
					<form action="adminBlackPage.ad" method="post"
					...
					<script type="text/javascript">
						function enterKey() {
							if (window.event.keyCode == 13) { // Enter 키 코드값 13
								document.getElementById('_1admin_search_form')
										.submit();
							}
						}
					</script>
