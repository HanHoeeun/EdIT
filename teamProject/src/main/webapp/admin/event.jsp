...
<!--==================================== 2탭 이벤트 페이징 ==================================== -->
				<div class="_1qna_paging">
					<ul>
						...
						%>
						<li
							onclick="location.href='eventlist.no?pageNum=<%=pageDTO2.getStartPage() - pageDTO2.getPageBlock()%>&tab=tab-2'">Prev</li>
						...
						%>
						<li
							onclick="location.href='eventlist.no?pageNum=<%=i%>&tab=tab-2'"><%=i%></li>
						<%
						}
						...
						%>
						<li
							onclick="location.href='eventlist.no?pageNum=<%=pageDTO2.getStartPage() + pageDTO2.getPageBlock()%>&tab=tab-2'">Next</li>
						<%
						}
						%>
					</ul>
