			...
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">EdIT이란?</a></li>
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								<h5><img src="../images/aboutEdit_7.png" width="1260px" height="600px"alt="" /> </h5>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
         <!-- <a href="beverages.html"> --> <img class="first-slide" src="images/aboutEdit_7.png"  width="1920px" height="600px" alt="First slide"></a>
       
        </div>
        <div class="item">
         <!-- <a href="personalcare.html"> --> <img class="second-slide " src="images/roleEdit_7.png" width="1920px" height="600px" alt="Second slide"></a>
