				...
				<div id="tab-2" class="tab-content">
					<form action="writePro.bo" method="post" enctype="multipart/form-data">
						<table class="_1q_query_tab">
							...
							<td class="_1q_query_tab_4" colspan="3" ><input type="text" name="subject" placeholder="제목을 작성하세요" style="border:none;"></td>						
							</tr>
						</table>
						<div><br></div>
						<table class="_1q_query_tab">
						...
						<table class="_1q_query_tab">
							<tr>
							<td class="_1q_query_tab_5" colspan="3"><textarea name="content" style="border:none;" cols="110" rows="20" class="noresize" placeholder="내용을 작성하세요" ></textarea></td>
							</tr>
						</table>
